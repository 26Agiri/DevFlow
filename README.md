...
Configure the local database credentials in:devFlow/src/main/resources/application-local.properties
...
#Frontend Setup
Navigate to:devFlow-frontend/Devflow-automate
...
#The repository ignores local configuration such as:application-local.properties.env
